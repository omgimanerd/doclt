 ...
 * @return {string}
 */
var getUsageString = function(depth, command, demandSubcommand) {
  var usage = ['Usage:\n', '', '$0'];
  if (depth > 1) {
    /**
 ...
 */
exports.globalConfig = function(yargs, depth, command, demandSubcommand) {
  if (demandSubcommand) {
 ...
 */
exports.handleFail = function(message, error, yargs) {
